...
export const FOLLOWERS_HISTORY_STORAGE_KEY = 'iu_followers-history';
export const FOLLOWINGS_HISTORY_STORAGE_KEY = 'iu_followings-history';
export const LAST_SCAN_DATE_STORAGE_KEY = 'iu_last-scan-date';
